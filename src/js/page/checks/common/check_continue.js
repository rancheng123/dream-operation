...
class CheckContinue extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            th : "审核订单变更-续租"
    ...
    render() {
      ...
      const { sales_rules={},sales_rules : {},finance_info = {},
                       ...
                       />
                        ...
                        <Form>
                          ...
                          </Col>
                          {
                            ...
                            label = "配送积分配额"
                            >
                              <span>{sales_rules.presented_goods.present_credits}&ensp;<span className="border_mon">积分/月</span></span>
                              <span style={{marginLeft : 24}}>{sales_rules.presented_goods.present_prints}&ensp;<span className="border_mon">打印纸张数/月</span></span>
                            </Form.Item>
                            </Col>
                            ) : ''
                          }
