...
@Form.create()
class organizeCreate extends Component {
    constructor(props) {
        super(props);
        this.state = { 
         };
    ...
    save(){
        ...
        form.validateFieldsAndScroll({first : true},(err,values)=>{
            ...
            api.createOrganize(data).then(res=>{
                if(res.code != 10000){
    ...
    render() {
        ...
        const { organizeTypeList,params,ownerList } = this.props.organize_detail;
        ...
        return (
            <div className="organizeOp">
                ...
                <div style={styleCSS.container}>
                        ...
                        <div style={{marginTop : 16}}>
                            <Row>
                                ...
                                {getFieldDecorator('identity_type', {
                                    validateFirst : true,
                                    initialValue : params.identity_type,
                                    rules: [
                    ...
                    <div className='flex' style={{width : 172,marginTop : 86}}><Button style={{backgroundColor : '#FFF'}} >取消</Button><Button type="primary" onClick={this.save}>保存</Button></div>
                    <SuccessModel onclickFilter={this.showSuccessView} filter_visible={this.state.showSuccess} title={'组织新建成功'} content={'组织新建成功'}></SuccessModel>
                </div>
                </ShadowBox>
            </div>
        );
